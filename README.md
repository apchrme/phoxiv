...
```
3. Add `/src/routes/contests/<contest id>/+page.svx` and use it to type a description for the contest. (Yes, this is kind of weird; I will find a cleaner solution to this soon)
