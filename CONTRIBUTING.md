...
## Migrating to R2 and D1

R2: use `bun run sync:push` to push the files to R2.
D1: After running the pregeneration script, run `bun run migrate:d1` to seed the database with the relevant data.
