...
# Note 21-04-2026: I am currently migrating all of the olympiad files in static to a CDN. Do not open any PRs now, for they may be invalidated by a force push. You may also have to re-clone the repository. See [migration.md](/migration.md)
